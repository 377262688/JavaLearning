...
在中低程度的竞争时，原子变量能提供更好的伸缩性，而在高强度的竞争情况下，锁能有效的避免竞争
  
在高度竞争时，锁的性能超过原子变量，但在更真实的环境中，原子变量会超过锁的性能，这是因为锁会挂起线程，从而降低了CPU利用率和总线上的通信总量

另一方面，CAS在高度竞争的环境中，会不断重试，更加加剧了竞争。

使用ThreadLocal来避免使用共享状态，从而提高处理效率
